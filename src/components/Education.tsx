...
const Education = () => {
    ...
    return (
        <div className='text-white bg-gradient-to-b from-black to-black py-18 mt-52' id="education"
            ...
            <div className="px-6 md:px-0 max-w-[1000px] mx-auto mt-40 space-y-24" data-aos="fade-right">
                {theplace.map((project, index) => (
                    <motion.div
                        ...
                        <div className='flex justify-center items-center'>
                            <Image src={project.scr} alt={project.title} className='h-[200px] w-auto object-cover'data-aos="fade-left" />
                        </div>
                    </motion.div>
